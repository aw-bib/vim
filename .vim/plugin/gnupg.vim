...
if (exists("loaded_gnupg") || &cp || exists("#BufReadPre#*.gpg")|| exists("#BufReadPre#*.asc"))
	finish
endi
let loaded_gnupg = 1
...
" -------------------------- a.w. Fri Apr 29 08:07:49 CEST 2005 
" Also enable this for *.asc
	autocmd BufNewFile,BufReadPre,FileReadPre      *.asc set viminfo=
	autocmd BufNewFile,BufReadPre,FileReadPre      *.asc set noswapfile
	autocmd BufNewFile                             *.asc call s:GPGEditRecipients()
	autocmd BufReadPre,FileReadPre                 *.asc set bin
	autocmd BufReadPost,FileReadPost               *.asc call s:GPGDecrypt()
	autocmd BufReadPost,FileReadPost               *.asc set nobin
	autocmd BufReadPost,FileReadPost               *.asc execute ":doautocmd BufReadPost " . expand("%:r")
	autocmd BufReadPost,FileReadPost               *.asc execute ":redraw!"
	autocmd BufWritePre,FileWritePre               *.asc set bin
	autocmd BufWritePre,FileWritePre               *.asc call s:GPGEncrypt()
...
com! GPGDecrypt        call s:GPGDecrypt()
com! GPGEncrypt        call s:GPGEncrypt()

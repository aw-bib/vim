"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"
" Some settings to use vim as editor for HTML
...
function! Tag(tag)
  execute "normal `>a</" . a:tag . ">\<Esc>`<i<" . a:tag . ">\<Esc>"
endfunction

" Enable smart backspace to remove umlauts e.g.
inoremap <BS> x<Esc>:call SmartBS('\&\S*;')<CR>a<BS><BS>
" Map umlauts to there HTML equivalent 
if has("os2")
   imap Ñ &auml;
   imap î &ouml;
   imap Å &uuml;
...
"
vmap ,Tag <Esc>:call Tag(input("tag name = "))<cr>
